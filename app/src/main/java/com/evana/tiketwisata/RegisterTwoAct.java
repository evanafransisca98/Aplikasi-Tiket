...
import com.evana.tiketwisata.RegisterOneAct;
import com.evana.tiketwisata.SuccessRegisterAct;
...
public class RegisterTwoAct extends AppCompatActivity {
    ...
    ImageView pic_photo_regist_user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pic_photo_regist_user = findViewById(R.id.pic_photo_regist_user);
            ...
            public void onClick(View v) {
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        dataSnapshot.getRef().child("username").setValue(nama_lengkap.getText().toString());
                                ...
                                public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                                    storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            ...
                                            reference.getRef().child("username").setValue(nama_lengkap.getText().toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == photo_max && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            Picasso.with(this).load(photo_location).centerCrop().fit().into(pic_photo_regist_user);
